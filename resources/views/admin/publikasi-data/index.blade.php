...
<head>
    ...
    <title>Kelola Publikasi Data - Dinas Perikanan Bolmut</title>
        ...
        <div class="flex flex-col flex-1 h-full overflow-hidden relative">
            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    ...
                    <h5 class="text-heading font-semibold text-base">Kelola Publikasi Data</h5>
                </div>
                <div class="flex items-center gap-4">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto px-6 pb-6">
                ...
                @if (session('success'))
                    <div
                        class="mb-4 px-4 py-3 bg-success/10 text-green-700 border border-success/30 rounded-xl text-sm flex items-center gap-2">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                    {{-- Filter Tahun --}}
                    <form method="GET" action="{{ route('admin.publikasi-data.index') }}"
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <form action="{{ route('admin.publikasi-data.destroy', $row->id) }}"
                                                    method="POST"
