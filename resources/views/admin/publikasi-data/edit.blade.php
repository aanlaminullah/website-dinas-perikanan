...
<head>
    ...
    <title>Edit Data Produksi - Dinas Perikanan Bolmut</title>
        ...
        <div class="flex flex-col flex-1 h-full overflow-hidden relative">
            ...
            <header
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h5 class="text-heading font-semibold text-base">Edit Data Produksi</h5>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="komoditas"
                                    value="{{ old('komoditas', $produksiBudidaya->komoditas) }}" list="komoditas-list"
                            ...
                            <div>
                                ...
                                <input type="number" name="tahun"
                                    value="{{ old('tahun', $produksiBudidaya->tahun) }}" min="2000" max="2099"
                            ...
                            @foreach (['januari', 'februari', 'maret', 'april', 'mei', 'juni', 'juli', 'agustus', 'september', 'oktober', 'november', 'desember'] as $bulan)
                                <div>
                                    ...
                                    <input type="number" name="{{ $bulan }}"
                                        value="{{ old($bulan, $produksiBudidaya->$bulan) }}" min="0"
                                        step="0.001"
